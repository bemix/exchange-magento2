...
class PaymentInfo extends \Magento\Framework\View\Element\Template
{
    ...
    public function __construct(
        ...
        $this->setTemplate('Allsecureexchange_Allsecureexchange::email_payment_info.phtml');
        $this->helper = $helper;
    ...
    /**
     * Get order object from url parameter
     *
     * return \Magento\Sales\Model\OrderFactory object
     */
    public function getRealOrder()
    {
        $order_id = $order_id = (int)$this->getData("order_id");
