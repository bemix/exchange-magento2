        ...
        return Component.extend({
            ...
            placeOrder: function (data, event) {
                ...
                if (this.isSeamless()) {
                    ...
                    var form = $('#allsecureexchange_form_' + this.getCode());
                    ...
                    this.paymentJs.tokenize(
                        ...
                        (errors) => {
                            errors.forEach(message => {
                                validator.showLabel($('#allsecureexchange_cc_' + message.attribute + '_' + this.getCode()).get(0), message.message);
                            });
            ...
            afterPlaceOrder: function () {
                ...
                $.ajax({
                    url: url.build('allsecureexchange/payment/frontend'),
                    type: 'post',
                    data: data,
                    success: (result) => {
                        console.log(result);
            ...
            initializeJsIntegration: function() {
                ...
                this.paymentJs.init(this.config.integration_key, 'allsecureexchange_cc_number_' + this.getCode(), 'allsecureexchange_cc_cvv_' + this.getCode(), function(payment) {
                    var style = {
